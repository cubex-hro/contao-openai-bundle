...
$GLOBALS["TL_LANG"][$strTable] = [
    ...
    "gptsettings_legend"    => "GPT settings",
    "gptseo_legend"         => "SEO settings",
    "chatbot_legend"           => "Chatbot settings",
    ...
    "gpt_model_custom"      => ["GPT custom model","Enter your custom model here, e.g.: lmstudio-community/Meta-Llama-3-8B-Instruct-GGUF"],
    "gpt_endpoint_custom"   => ["GPT custom endpoint","Enter your custom endpoint here, e.g.: http://localhost:1234/v1/chat/completions"],
    "gpt_role_prompt"       => ["GPT role","Enter a role here, e.g.: Answer only in sequence"],
    ...
    "chatbot_endpoint_custom"  => ["Chatbot custom endpoint","Enter your custom endpoint here, e.g.: http://localhost:1234/v1/chat/completions"],
    "chatbot_role_prompt"      => ["Chatbot role","Enter a role here, e.g.: Antworte ausschließlich in Reihmen"],
    "chatbot_model_custom"     => ["Chatbot custom model","Enter your custom model here, e.g.: lmstudio-community/Meta-Llama-3-8B-Instruct-GGUF"]
];